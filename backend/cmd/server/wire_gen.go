...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	paymentService := service.ProvidePaymentService(client, db, registry, defaultLoadBalancer, redeemService, subscriptionService, paymentConfigService, userRepository, groupRepository, affiliateService, notificationEmailService)
	...
	paymentHandler := handler.ProvideAdminPaymentHandler(paymentService, paymentConfigService, totpService, userService)
