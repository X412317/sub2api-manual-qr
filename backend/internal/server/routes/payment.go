...
func RegisterPaymentRoutes(
	...
	authenticated.Use(panelRateLimiter.Global())
	{
		...
		orders := authenticated.Group("/orders")
		{
			...
			orders.POST("/:id/manual-proof", paymentHandler.SubmitManualProof)
			orders.GET("/:id/manual-proof", paymentHandler.GetManualProof)
			orders.GET("/:id/manual-qr", paymentHandler.GetManualQR)
	...
	adminGroup.Use(middleware.AdminComplianceGuard(settingService))
	{
		...
		adminGroup.GET("/manual-reviews/summary", adminPaymentHandler.GetManualReviewSummary)
		...
		adminOrders := adminGroup.Group("/orders")
		{
			...
			adminOrders.GET("/:id/manual-proof", adminPaymentHandler.GetManualProof)
			adminOrders.POST("/:id/manual-review", adminPaymentHandler.ReviewManualProof)
		}
		...
		providers := adminGroup.Group("/providers")
		{
			...
			providers.GET("/:id/manual-qr-assets", adminPaymentHandler.ListManualQRAssets)
			providers.POST("/:id/manual-qr-assets", adminPaymentHandler.SaveManualQRAsset)
			providers.DELETE("/:id/manual-qr-assets/:assetId", adminPaymentHandler.DeleteManualQRAsset)
			providers.GET("/:id/manual-qr-assets/:assetId/image", adminPaymentHandler.GetManualQRAssetImage)
		}
	}
}
