...
const (
	...
	VisibleMethodSourceManualAlipay   = "manual_qr_alipay"
	VisibleMethodSourceManualWechat   = "manual_qr_wxpay"
...
func NormalizeVisibleMethodSource(method, source string) string {
	...
	case payment.TypeAlipay:
		...
		case VisibleMethodSourceManualAlipay, payment.TypeManualQR:
	...
	case payment.TypeWxpay:
		...
		case VisibleMethodSourceManualWechat, payment.TypeManualQR:
...
func VisibleMethodProviderKeyForSource(method, source string) (string, bool) {
	...
	case VisibleMethodSourceManualAlipay:
		return payment.TypeManualQR, NormalizeVisibleMethod(method) == payment.TypeAlipay
	case VisibleMethodSourceManualWechat:
		return payment.TypeManualQR, NormalizeVisibleMethod(method) == payment.TypeWxpay
	default:
		return "", false
	}
}
