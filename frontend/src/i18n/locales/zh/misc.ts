export default {
  ...
  payment: {
    ...
    manual: {
      title: '人工二维码充值',
      statusSubmitted: '待人工审核',
      statusApproved: '审核已通过',
      statusRejected: '凭证已驳回',
      reviewNoExpiry: '审核中，不会过期',
      crediting: '正在入账',
      awaitingReview: '付款凭证已提交',
      awaitingReviewHint: '订单已进入人工审核，审核期间不会自动过期，也不能取消。',
      approved: '凭证审核通过',
      approvedProcessing: '系统正在完成余额入账，请勿重复付款。',
      rejected: '付款凭证未通过',
      attemptsRemaining: '还可提交 {count} 次',
      qrAlt: '收款二维码',
      openingAlipay: '正在尝试打开支付宝...',
      openAlipay: '打开支付宝',
      alipayFallbackHint: '未能打开支付宝时，请保存二维码后在支付宝扫一扫中从相册识别。',
      wechatSaveHint: '微信不保证同机唤起，请保存二维码后使用微信扫一扫从相册识别。',
      transactionNo: '支付交易号',
      transactionNoPlaceholder: '输入支付宝或微信交易号',
      proofImage: '付款截图',
      chooseProof: '选择付款截图',
      proofRules: 'PNG / JPEG / WebP，不超过 5 MB',
      invalidProofType: '付款截图仅支持 PNG、JPEG 或 WebP',
      proofTooLarge: '付款截图不能超过 5 MB',
      submitProof: '提交付款凭证',
      submitSuccess: '付款凭证已提交，等待管理员审核',
      submitFailed: '付款凭证提交失败',
    },
    refundReason: '退款原因',
    ...
    errors: {
      ...
      MANUAL_PAYMENT_INVALID_TIER: '请选择 10、20、50、100、200、500 或 1000 元固定档位',
      MANUAL_PAYMENT_BALANCE_ONLY: '人工二维码仅支持余额充值',
      MANUAL_PAYMENT_INVALID_CHANNEL: '人工二维码支付渠道无效',
      MANUAL_PAYMENT_FEE_MUST_BE_ZERO: '人工二维码要求充值手续费保持 0%',
      MANUAL_PAYMENT_MULTIPLIER_MUST_BE_ONE: '人工二维码要求充值倍率保持 1:1',
      MANUAL_PAYMENT_PROVIDER_MISCONFIGURED: '人工二维码服务商必须使用二维码模式',
      MANUAL_PAYMENT_STORAGE_UNAVAILABLE: '私有支付图片存储不可用，请联系管理员',
      MANUAL_PAYMENT_QR_UNREADABLE: '未能识别图片中的二维码',
      MANUAL_PAYMENT_QR_INVALID: '二维码内容不是受支持的收款链接',
      MANUAL_PAYMENT_QR_CHANNEL_MISMATCH: '二维码与所选支付宝或微信渠道不匹配',
      MANUAL_PAYMENT_INVALID_TRANSACTION_NO: '交易号应为 6-128 位字母、数字、下划线或短横线',
      MANUAL_PAYMENT_DUPLICATE_TRANSACTION_NO: '该渠道的交易号已经提交过',
      MANUAL_PAYMENT_ALREADY_SUBMITTED: '已有付款凭证正在等待审核',
      MANUAL_PAYMENT_PROOF_SUBMITTED: '已提交付款凭证的订单不能取消',
      MANUAL_PAYMENT_SUBMISSION_LIMIT: '该订单最多只能提交 3 次付款凭证',
      MANUAL_PAYMENT_ORDER_EXPIRED: '订单已过期，请重新创建',
      MANUAL_PAYMENT_AMOUNT_MISMATCH: '实收金额必须与订单实付金额完全一致',
      MANUAL_PAYMENT_ALREADY_REVIEWED: '该付款凭证已被审核，请刷新页面',
      MANUAL_PAYMENT_REJECTION_REASON_REQUIRED: '驳回原因必须填写 2-1000 个字符',
    ...
    admin: {
      ...
      manualReview: {
        title: '人工付款审核',
        privateHint: '付款截图为私有凭证，仅在当前鉴权页面读取。',
        pendingQueue: '待审核',
        review: '审核',
        proofImage: '付款截图',
        imageUnavailable: '付款截图已清理或暂时无法读取',
        submission: '提交次数',
        expectedAmount: '订单应收',
        receivedAmount: '实际收到',
        submittedAt: '提交时间',
        ...
        reasonPlaceholder: '填写少付、多付、截图不清晰等具体原因',
        approve: '通过',
        reject: '驳回',
        amountMismatch: '批准时必须输入与 {amount} 完全一致的金额',
        approveWarning: '批准后订单将立即置为已支付并发放对应余额。此操作需要 TOTP 二次验证，且不能修改到账额度。',
        confirmApprove: '验证并批准入账',
        confirmReject: '确认驳回',
        approveSuccess: '审核通过，余额已发放',
        rejectSuccess: '付款凭证已驳回，订单倒计时已重置',
        status: {
          not_submitted: '未提交',
          submitted: '待审核',
          approved: '已通过',
