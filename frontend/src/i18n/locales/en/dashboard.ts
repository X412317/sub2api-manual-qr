export default {
  ...
  apiDocs: {
    ...
    subtitle: 'Use one API key with OpenAI, Anthropic, and Gemini-compatible protocols. Addresses and examples on this page automatically follow the current site configuration.',
    ...
    quickStart: {
      title: 'Quick start',
      description: 'Go from a new key to your first request in three steps',
      step1Title: 'Create an API key',
      step1Description: 'Sign in, create a key on the API Keys page, and select an available group.',
      step2Title: 'Choose a model',
      step2Description: 'Use Model Plaza to confirm the model ID, billing mode, and effective rate.',
      step3Title: 'Send a request',
      step3Description: 'Choose the compatible endpoint for your client and replace the key and model in the example.',
      securityNote: 'Your full API key is shown only when it is created. Keep it in a server-side environment variable, never in frontend code, public repositories, or chat messages.'
    },
    authentication: {
      title: 'Authentication',
      description: 'Every model request requires an API key. Send it in the native header for your client protocol; URL query parameters are no longer supported for keys.',
    ...
    firstRequest: {
      ...
      description: 'Choose your client protocol. Replace your-model-id with a model ID that is available in Model Plaza.',
    ...
    endpoints: {
      ...
      description: 'These are the most common compatible endpoints. Availability still depends on the group and model assigned to your API key.',
      method: 'Method',
      path: 'Path',
      purpose: 'Purpose',
      models: 'List models visible to the current API key',
      responses: 'OpenAI Responses API for new projects and tool use',
      chat: 'OpenAI Chat Completions compatible requests',
      messages: 'Anthropic Messages compatible requests',
      countTokens: 'Estimate message tokens before sending a request',
      gemini: 'Native Gemini generateContent requests',
      images: 'Synchronous image generation when supported by the model and group',
      embeddings: 'Vector embeddings for platforms with embedding support'
    },
    sdk: {
      title: 'SDK setup',
      description: 'Official SDKs usually require only a custom API key and Base URL. Inject keys through environment variables.'
    },
    errors: {
      title: 'Error handling',
      description: 'Record the response status and request id, and use exponential backoff only for retryable failures.',
      badRequest: 'The request parameters, model name, or message format is invalid.',
      unauthorized: 'The API key is missing, malformed, or no longer active.',
      forbidden: 'The current user, key, or group cannot access this model.',
      rateLimited: 'A concurrency, RPM, quota, or upstream limit was reached. Read the error and retry with backoff.',
      server: 'The gateway or upstream is temporarily unavailable. Keep the request id and retry a limited number of times after a short backoff.'
    },
    faq: {
      title: 'Frequently asked questions',
      modelQuestion: 'What should I use as the model name?',
      modelAnswer: 'Use the complete model ID shown in Model Plaza or returned by GET /v1/models. Available models can differ by group, so use the group assigned to your API key as the source of truth.',
      balanceQuestion: 'Which units are used for prices and balance?',
      balanceAnswer: 'Token prices in Model Plaza are shown in USD per one million tokens. Actual charges apply group, peak-hour, and administrator pricing rules.',
      streamQuestion: 'Is streaming supported?',
      streamAnswer: 'Yes. Set stream to true for Responses, Chat Completions, or Messages requests and keep reading the event stream in your client.',
      errorQuestion: 'How should I retry 429 or 5xx responses?',
      errorAnswer: 'Use exponential backoff with jitter and a maximum retry count. Do not immediately replay many requests in parallel. If failures persist, contact site support with the request id.'
    }
  },
  ...
  modelPlaza: {
    title: 'Model Plaza',
    eyebrow: 'Live model catalog',
    description: 'Find available models and compare your price with official reference pricing',
    loading: 'Loading...',
    empty: 'No groups to display',
    loadFailed: 'Failed to load model plaza',
    loadFailedHint: 'Model data is temporarily unavailable. Please try again shortly.',
    retry: 'Reload',
    noSearchResult: 'No matching models',
    anonymousHint: 'Sign in to see your exclusive groups and personal rates',
    signInForRates: 'Sign in for personal pricing',
    viewDocs: 'View API documentation',
    resetFilters: 'Clear filters',
    resultSummary: '{groups} groups and {models} models found',
    pricingNote: 'Displayed prices use the currently effective rate and are provided for reference. Final charges follow actual request usage and billing records.',
    controls: {
      priceMode: 'Price display mode', paid: 'Paid', official: 'Official', unit: 'Price unit',
      perMillion: '/1M', perThousand: '/1K', sort: 'Sort', latest: 'Latest', name: 'Name', price: 'Price',
      view: 'View mode', grid: 'Card view', list: 'List view', details: 'Details',
      modelPricing: 'Token price calculated with the current group rate', tieredPricing: 'Tiered pricing available', imagePricing: 'Billed per image or request'
    },
    ...
    table: {
      ...
      officialReference: 'Show official reference prices',
      rate: 'Rate',
      unitPerMillion: '$ / 1M tokens',
