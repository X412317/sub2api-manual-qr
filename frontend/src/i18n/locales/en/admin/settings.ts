export default {
    settings: {
      ...
      payment: {
        ...
        manualQRAssetsTitle: 'Collection QR Codes',
        manualQRAssetsHint: 'Configure general and fixed-amount QR codes for Alipay and WeChat Pay. A matching fixed amount is preferred; otherwise the general code is used.',
        manualQRSaveFirst: 'This provider starts disabled. Save it, edit it again to upload collection QR codes, then enable it after verification.',
        manualQRGeneric: 'General QR',
        manualQRFixed: 'CNY {amount} QR',
        manualQRNotUploaded: 'Not uploaded',
        manualQRUploadRules: 'PNG, JPEG, or WebP only, up to 1 MB. The image must contain a readable collection QR code matching the selected channel.',
        manualQRUploadSuccess: 'Collection QR code saved',
        manualQRDeleteSuccess: 'Collection QR code deleted',
      },
      balanceNotify: {
