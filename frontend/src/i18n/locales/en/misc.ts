export default {
  ...
  payment: {
    ...
    manual: {
      title: 'Manual QR Top-Up',
      statusSubmitted: 'Awaiting Review',
      statusApproved: 'Approved',
      statusRejected: 'Proof Rejected',
      reviewNoExpiry: 'No expiry during review',
      crediting: 'Crediting balance',
      awaitingReview: 'Payment proof submitted',
      awaitingReviewHint: 'The order is awaiting manual review. It will not expire and cannot be cancelled during review.',
      approved: 'Payment proof approved',
      approvedProcessing: 'The balance is being credited. Do not pay again.',
      rejected: 'Payment proof rejected',
      attemptsRemaining: '{count} submissions remaining',
      qrAlt: 'Collection QR code',
      openingAlipay: 'Trying to open Alipay...',
      openAlipay: 'Open Alipay',
      alipayFallbackHint: 'If Alipay does not open, save the QR code and select it from the Alipay scanner photo album.',
      wechatSaveHint: 'Same-device WeChat handoff is not guaranteed. Save the QR code and select it from the WeChat scanner photo album.',
      transactionNo: 'Payment Transaction No.',
      transactionNoPlaceholder: 'Enter the Alipay or WeChat transaction number',
      proofImage: 'Payment Screenshot',
      chooseProof: 'Choose payment screenshot',
      proofRules: 'PNG / JPEG / WebP, up to 5 MB',
      invalidProofType: 'The screenshot must be PNG, JPEG, or WebP',
      proofTooLarge: 'The screenshot cannot exceed 5 MB',
      submitProof: 'Submit Payment Proof',
      submitSuccess: 'Payment proof submitted for administrator review',
      submitFailed: 'Failed to submit payment proof',
    },
    ...
    errors: {
      ...
      MANUAL_PAYMENT_INVALID_TIER: 'Choose a fixed amount: 10, 20, 50, 100, 200, 500, or 1000 CNY',
      MANUAL_PAYMENT_BALANCE_ONLY: 'Manual QR only supports balance top-ups',
      MANUAL_PAYMENT_INVALID_CHANNEL: 'Invalid manual QR payment channel',
      MANUAL_PAYMENT_FEE_MUST_BE_ZERO: 'Manual QR requires the recharge fee to remain 0%',
      MANUAL_PAYMENT_MULTIPLIER_MUST_BE_ONE: 'Manual QR requires a 1:1 recharge multiplier',
      MANUAL_PAYMENT_PROVIDER_MISCONFIGURED: 'Manual QR providers must use QR code mode',
      MANUAL_PAYMENT_STORAGE_UNAVAILABLE: 'Private payment image storage is unavailable',
      MANUAL_PAYMENT_QR_UNREADABLE: 'No readable QR code was found in the image',
      MANUAL_PAYMENT_QR_INVALID: 'The QR code is not a supported collection link',
      MANUAL_PAYMENT_QR_CHANNEL_MISMATCH: 'The QR code does not match the selected Alipay or WeChat channel',
      MANUAL_PAYMENT_INVALID_TRANSACTION_NO: 'Transaction numbers must be 6-128 letters, digits, underscores, or hyphens',
      MANUAL_PAYMENT_DUPLICATE_TRANSACTION_NO: 'This transaction number has already been submitted for the channel',
      MANUAL_PAYMENT_ALREADY_SUBMITTED: 'A payment proof is already awaiting review',
      MANUAL_PAYMENT_PROOF_SUBMITTED: 'Orders with submitted payment proof cannot be cancelled',
      MANUAL_PAYMENT_SUBMISSION_LIMIT: 'Payment proof can only be submitted 3 times for this order',
      MANUAL_PAYMENT_ORDER_EXPIRED: 'The order has expired. Create a new order.',
      MANUAL_PAYMENT_AMOUNT_MISMATCH: 'The received amount must exactly match the order payment amount',
      MANUAL_PAYMENT_ALREADY_REVIEWED: 'This payment proof has already been reviewed. Refresh the page.',
      MANUAL_PAYMENT_REJECTION_REASON_REQUIRED: 'A rejection reason of 2-1000 characters is required',
    ...
    admin: {
      ...
      manualReview: {
        ...
        privateHint: 'Payment screenshots are private and are only loaded through this authenticated view.',
        pendingQueue: 'Pending Review',
        review: 'Review',
        proofImage: 'Payment Screenshot',
        imageUnavailable: 'The payment screenshot has been removed or is temporarily unavailable',
        ...
        reasonPlaceholder: 'Describe underpayment, overpayment, an unclear screenshot, or another issue',
        approve: 'Approve',
        reject: 'Reject',
        amountMismatch: 'Approval requires an amount exactly matching {amount}',
        approveWarning: 'Approval immediately marks the order paid and credits its fixed balance. TOTP verification is required and the credited amount cannot be changed.',
        confirmApprove: 'Verify and Credit',
        confirmReject: 'Confirm Rejection',
        approveSuccess: 'Approved and balance credited',
        rejectSuccess: 'Proof rejected and the order timer reset',
        status: {
