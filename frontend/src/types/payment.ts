...
export type PaymentType = 'alipay' | 'wxpay' | 'alipay_direct' | 'wxpay_direct' | 'stripe' | 'easypay' | 'airwallex' | 'manual_qr'
...
export type ManualProofStatus = 'not_submitted' | 'submitted' | 'approved' | 'rejected'
...
export interface ManualPaymentProof {
  ...
  submitted_at?: string
  reviewed_at?: string
  proof_deleted_at?: string
  attempts_used: number
  attempts_remaining: number
  can_submit: boolean
  qr_code_url?: string
  alipay_launch_payload?: string
}

export interface ManualQRAsset {
  id: number
